...
- [x] Подключение OpenClaw как модели (OpenAI-совместимый API) — ключ прописан, контейнер перезапущен
- [ ] Первый вход и создание admin-аккаунта (http://89.104.65.27:3000)
- [ ] Настройка пользователей и ролей
- [ ] DNS: A-запись ai.npln.tech → 89.104.65.27
- [ ] SSL + nginx (certbot --nginx -d ai.npln.tech)
